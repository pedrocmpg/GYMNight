...
from src.ui_models.models import COL_EXERCISE, COL_WEIGHT, COL_REPS, COL_SET_TYPE, SuggestionRole, SET_TYPES
from src.ui.theme import C_GREEN, C_CARD, C_CARD2, C_BORDER, C_BG, C_TEXT, C_TEXT2, C_TEXT3, RADIUS_SM, RADIUS_MD
